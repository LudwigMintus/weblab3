...
public class DB {
    ...
    private DB() {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:postgresql://localhost:5433/weblab3", "postgres", "postgres");
            // conn = DriverManager.getConnection("jdbc:postgresql://pg:5432/studs", "s365829", "Yd1QLCjlo5HnM3Xq");
